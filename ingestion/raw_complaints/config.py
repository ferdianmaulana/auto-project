...
API_ENDPOINT = "/complaints/complaintsByVehicle"
...
UNIQUE_ID_FIELD = "odiNumber"

WRITE_MODE = "APPEND"

VALIDATION_CHECKS = {
    "no_null_odiNumber":          "SELECT COUNT(*) FROM `{table_id}` WHERE odiNumber IS NULL",
    ...
    "no_future_complaint_date":   "SELECT COUNT(*) FROM `{table_id}` WHERE dateComplaintFiled > CURRENT_TIMESTAMP()",
